    ...
    <div className="bg-white min-h-full flex items-center justify-center py-12">
      <Card className="w-full max-w-7xl overflow-hidden p-0 shadow-2xl rounded-3xl border-none relative drop-shadow-2xl">
        <div 
          ...
          style={{backgroundImage: "url('https://plus.unsplash.com/premium_photo-1661964177687-57387c2cbd14?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')"}}
        />
