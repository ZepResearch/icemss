  ...
  return (
    <section className="w-full py-8 ">
      <div className="container mx-auto px-4 md:px-6">
        <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-4xl text-center sm:text-left mb-8 underline underline-offset-2 decoration-primary dark:decoration-yellow-50">
