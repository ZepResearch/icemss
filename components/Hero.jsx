...
export function Hero() {
  return (
    <DicedHeroSection
      ...
      onMainButtonClick={() => console.log("Registration clicked")}
      onGridImageHover={index => console.log(`Organizer image ${index} hovered`)}
      onGridImageClick={index => console.log(`Organizer image ${index} clicked`)}
      topTextStyle={{ 
        color: "#005baa",
        fontSize: "1.2rem",
        fontWeight: "600",
...
//   "https://images.unsplash.com/photo-1478436127897-769e1b3f0f36?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
// ]
