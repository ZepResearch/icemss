...
export default function Banner() {
  return (
    <div className=" relative z-10 flex mx-auto items-center gap-x-6 overflow-hidden bg-gradient-to-r from-yellow-600/70 to-red-600/70   px-6 py-2.5 sm:px-3.5  sm:before:flex-1">
