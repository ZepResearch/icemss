            ...
            >
              <div className="bg-white rounded-xl p-4 relative">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                  ...
                  <Link href="/registration">
                    <Button
                      className="bg-gradient-to-r from-sky-500 to-blue-500 hover:from-sky-600 hover:to-blue-600 text-white font-bold px-6 py-2 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 whitespace-nowrap"
                    >
                      Claim Now →
                    </Button>
                  </Link>
