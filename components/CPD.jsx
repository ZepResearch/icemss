...
function CPD() {
  return (
    <div className='my-4 max-w-6xl mx-auto px-4'>
      {/* CTA Banner Style Container */}
      <div className="bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 rounded-2xl shadow-2xl overflow-hidden relative">
        {/* Background Pattern */}
        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-3 gap-6 items-center p-8 lg:p-12">
          ...
          <div className="space-y-4 lg:col-span-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <a href='https://www.cpdstandards.com/become-accredited/events-conferences/' className="bg-white text-blue-700 px-6 py-3 rounded-lg font-semibold hover:bg-blue-50 transition-colors duration-300 shadow-lg">
                Learn More
              </a>
              <a href='/registration' className="border-2 border-white text-white px-6 py-3 rounded-lg font-semibold hover:bg-white hover:text-blue-700 transition-colors duration-300">
                Get Started
              </a>
            </div>
          </div>
