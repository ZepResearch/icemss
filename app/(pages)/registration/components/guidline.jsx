            ...
            return (
              ...
              >
                <div className="flex items-center gap-4 md:gap-6">
                  <div className="flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-bl from-sky-400 via-blue-400 to-blue-400 text-primary-foreground font-bold text-lg flex-shrink-0">
                    {step.number}
                  </div>
