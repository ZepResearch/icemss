          ...
          <div className="px-8 py-6 space-y-8">
            ...
            <section>
              ...
              <div className="mt-4 p-4 bg-blue-50 rounded-lg border-l-4 border-blue-500">
                <p className="text-gray-700 text-sm">
                  <strong>Note:</strong> Participants requiring accommodations are encouraged to notify the Organizing Committee in advance via info@icemss.in to ensure timely arrangements.
                </p>
              </div>
            </section>
