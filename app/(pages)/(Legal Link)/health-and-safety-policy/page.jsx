          ...
          <div className="px-8 py-6 space-y-8">
            ...
            <div className="prose max-w-none">
              <p className="text-gray-700 leading-relaxed">
                The Organizing Committee of the  ICEMSS is committed to ensuring the health, safety, and well-being of all participants, including delegates, speakers, exhibitors, sponsors, and staff. We aim to provide a secure and comfortable environment that fosters knowledge exchange and professional networking.
              </p>
            </div>
              ...
              <div className="bg-gradient-to-r from-blue-100 to-blue-100 p-6 rounded-lg border-2 border-dashed border-blue-300">
                <div className="text-center">
                  ...
                  <p className="text-gray-700 text-sm max-w-2xl mx-auto">
                    By attending the  ICEMSS, all participants agree to adhere to this Health and Safety Policy, ensuring a secure and professional conference environment.
                  </p>
                </div>
              </div>
            </section>
