      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="px-8 py-8 space-y-8">
            ...
            {/* Section 2 */}
            <section>
              <h2 className="text-xl font-bold text-blue-900 mb-4">2. Scope of the Policy</h2>
            ...
            {/* Section 3 */}
            <section>
              <h2 className="text-xl font-bold text-blue-900 mb-4">3. Lodging a Complaint</h2>
            ...
            {/* Section 4 */}
            <section>
              <h2 className="text-xl font-bold text-blue-900 mb-4">4. Complaint Review Process</h2>
              <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
            ...
            {/* Section 5 */}
            <section>
              <h2 className="text-xl font-bold text-blue-900 mb-4">5. Resolution and Outcomes</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            {/* Section 6 */}
            <section>
              <h2 className="text-xl font-bold text-blue-900 mb-4">6. Confidentiality</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            {/* Section 7 */}
            <section>
              <h2 className="text-xl font-bold text-blue-900 mb-4">7. Appeals</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            {/* Section 8 */}
            <section>
              <h2 className="text-xl font-bold text-blue-900 mb-4">8. Contact Information</h2>
