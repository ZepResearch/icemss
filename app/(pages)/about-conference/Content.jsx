...
export default function ConferenceAboutSection() {
    ...
    const conferenceFeatures = [
      ...
      { icon: MapPin, text: "At the heart of Goa" },
            ...
            <Card className="bg-white/50 backdrop-blur-sm border-2 border-primary/20">
              <CardHeader>
                ...
                <CardContent>
                  ...
                  <p className="text-muted-foreground px-12 text-justify mt-2">
                  The conference, taking place on 12<sup>th</sup> - 13<sup>th</sup> December 2025 in  GOA (Hotel/ University), India, will offer researchers — both experienced and emerging — the opportunity to present their findings to esteemed members of the global scientific community. Regardless of their specific focus within Management, Education, or Social Sciences, ICEMSS will provide them with the exposure needed to gain recognition for their research. Moreover, the event will open doors for new collaborations and further research opportunities.
                  </p>
                </CardContent>
            </Card>
          </motion.div>
