export function getUserEmailTemplate(data) {
  ...
  <body>
    ...
    <div class="content">
      ...
      <p>
        We have received your submission and our review committee will evaluate it shortly.
        You will be notified about the status of your submission in the coming weeks.
      </p>
      ...
      <p>
        ...
        please contact us at info@icemss.in.
      </p>
